    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        ...
        <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none space-x-4">
          <Link className="bg-[#3441d4] px-6 py-2 rounded-[5px] items-center text-white" to="/dashboard">
            Home
          </Link>
          <Link className="bg-[#5b45b0] px-6 py-2 rounded-[5px] text-white" to="/customer">
            Customers
          </Link>
        </div>
      </div>
        ...
        <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
            <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
              ...
              {items.length === 0 && (
                <p className="text-white text-center mt-4">No any Current orders.</p>
              )}
            </div>
          </div>
        </div>
