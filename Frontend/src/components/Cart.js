                ...
                <div className='flex items-center justify-between px-4 py-4 space-x-5'>
                    <div className='flex flex-1 items-center justify-between text-white '>
                        <div className='leading-none'>
                            <p className='text-md font-semibold'>{customer.length> 0 ? customer[0]?.tableNum : "Table"}</p>
                            <small className='p'>{customer.length>0 ? customer[0]?.name : "Customer name"}</small>
                        </div>
